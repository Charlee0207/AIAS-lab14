...
def data_gen():
    ...
    assem.append("")
    assem.append("DMA_REG_BASE_ADDR:")
    assem.append(".word 0x300000")
    assem.append("")
    ...
    assem.append("")
    assem.append("DMA_OFFSET_ENABLE:")
    assem.append(".word 0x0")
    assem.append("")
    assem.append("DMA_OFFSET_SOURCE_INFO:")
    assem.append(".word 0x4")
    assem.append("")
    assem.append("DMA_OFFSET_DEST_INFO:")
    assem.append(".word 0x8")
    assem.append("")
    assem.append("DMA_OFFSET_SIZE_CFG:")
    assem.append(".word 0xc")
    assem.append("")
    assem.append("DMA_OFFSET_DONE:")
    assem.append(".word 0x14")
    assem.append("")
...
def dma_assem_gen():
    ...
    assem.append("")
    assem.append("## 4. Enable DMA")
    assem.append("li t1, 0")
    assem.append("add t1, t1, t0")
    assem.append("li t2, 0x01")
    assem.append("sw t2, 0(t1)")
    assem.append("")
    assem.append("## ... moving data ...")
    assem.append("wait_dma_transfer_a:")
    assem.append("la t6, DMA_OFFSET_DONE")
    assem.append("lw t1, 0(t6)")
    assem.append("add t1, t1, t0")
    assem.append("lw t2, 0(t1)")
    assem.append("beq t2, x0, wait_dma_transfer_a")
    assem.append("")
    assem.append("## reset DONE reg in DMA")
    ...
    assem.append("")
    assem.append("## ... moving data ...")
    assem.append("wait_dma_transfer_b:")
    assem.append("la t6, DMA_OFFSET_DONE")
    assem.append("lw t1, 0(t6)")
    assem.append("add t1, t1, t0")
    assem.append("lw t2, 0(t1)")
    assem.append("beq t2, x0, wait_dma_transfer_b")
    assem.append("")
    assem.append("## reset DONE reg in DMA")
    assem.append("sw x0, 0(t1)")
...
def main():
    ...
    with open("HW14_3_3_DMA.S", "w") as f:
        for code in assem:
            f.write(f"{code}\n")
