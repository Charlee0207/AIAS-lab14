...
class topTest extends AnyFlatSpec
    ...
    with AXITester{
        val idWidth = HW14_3_3_SA_Config.s_id_width
        val addrWidth = HW14_3_3_SA_Config.addr_width
        val dataWidth = HW14_3_3_SA_Config.data_width
    "HW14_3_3_SA CPU" should "program SA to compute matrix multiplication" in {
        test(new top()).withAnnotations(Seq(
            ...
            val lines    = Source.fromFile(HW14_3_3_SA_Config.instr_asm_path).getLines.toList
