...
class top extends Module {
    ...
    val cpu = Module(new PipelinedCPU(Lab14_2_3_Config.s_id_width, Lab14_2_3_Config.addr_width, Lab14_2_3_Config.data_width, Lab14_2_3_Config.instr_hex_path))
    val cpu_axi_if = Module(new CPU_AXI_IF(Lab14_2_3_Config.s_id_width, Lab14_2_3_Config.addr_width, Lab14_2_3_Config.data_width))
