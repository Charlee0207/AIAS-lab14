...
/* ---------------------------------------------------------------------------------------------+
 * HW14_3_2_SA consists of a single cycle CPU, SRAM, and accelerator connected via AXI bus.     |
...
class top extends Module {
    ...
    val cpu = Module(new PipelinedCPU(HW14_3_2_SA_Config.s_id_width, HW14_3_2_SA_Config.addr_width, HW14_3_2_SA_Config.data_width, HW14_3_2_SA_Config.instr_hex_path))
    val cpu_axi_if = Module(new CPU_AXI_IF(HW14_3_2_SA_Config.s_id_width, HW14_3_2_SA_Config.addr_width, HW14_3_2_SA_Config.data_width))
