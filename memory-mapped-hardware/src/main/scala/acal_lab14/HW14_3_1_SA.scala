...
/* ---------------------------------------------------------------------------------------------+
 * HW14_3_1_SA consists of a single cycle CPU, SRAM, and accelerator connected via AXI bus.     |
...
class top extends Module {
    val io = IO(new Bundle {
        ...
        val Hcf         = Output(Bool())
        val tb_slave    = new Axi4SlaveIF(HW14_3_1_SA_Config.s_id_width, HW14_3_1_SA_Config.addr_width, HW14_3_1_SA_Config.data_width)
    ...
    val cpu = Module(new PipelinedCPU(HW14_3_1_SA_Config.s_id_width, HW14_3_1_SA_Config.addr_width, HW14_3_1_SA_Config.data_width, HW14_3_1_SA_Config.instr_hex_path))
    val cpu_axi_if = Module(new CPU_AXI_IF(HW14_3_1_SA_Config.s_id_width, HW14_3_1_SA_Config.addr_width, HW14_3_1_SA_Config.data_width))
    val dm  = Module(new DataMem(HW14_3_1_SA_Config.s_id_width, HW14_3_1_SA_Config.data_mem_size, HW14_3_1_SA_Config.addr_width, HW14_3_1_SA_Config.data_width, HW14_3_1_SA_Config.data_hex_path))
    val sa  = Module(new topSA(HW14_3_1_SA_Config.s_id_width, HW14_3_1_SA_Config.addr_width, HW14_3_1_SA_Config.data_width, HW14_3_1_SA_Config.reg_width, SA_config.sa_mem_size))
    val dma = Module(new DMA(HW14_3_1_SA_Config.s_id_width, HW14_3_1_SA_Config.addr_width, HW14_3_1_SA_Config.data_width, HW14_3_1_SA_Config.Dma_Base_ADDR))
    // 3 master and 3 slaves
    val bus = Module(new AXILiteXBar(HW14_3_1_SA_Config.nMasters, HW14_3_1_SA_Config.nSlaves, HW14_3_1_SA_Config.s_id_width, HW14_3_1_SA_Config.addr_width, HW14_3_1_SA_Config.data_width, HW14_3_1_SA_Config.addr_map))
