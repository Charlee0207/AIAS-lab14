...
import acal_lab14.PipelinedCPU.MemIF._
import acal_lab14.PipelinedCPU.StageRegister._
import acal_lab14.PipelinedCPU.Controller._
import acal_lab14.PipelinedCPU.DatapathModule._
...
class PipelinedCPU(val mIdWidth: Int,val memAddrWidth: Int,val memDataWidth: Int, instrBinaryFile: String) extends Module {
    ...
    /* Wire Connect */
    // === IF stage reg (PC reg) ======================================================
    stage_IF.io.Stall := (controller.io.Hcf || controller.io.Stall_MA || controller.io.Stall_DH)       // To Be Modified
    ...
    datapath_IF.io.Mem_data := im.io.inst
    
    // --- Insruction Memory Interface
    // io.InstMem.Mem_R := controller.io.IM_Mem_R       // not used
    // io.InstMem.Mem_W :=  controller.io.IM_Mem_W      // not used
    // io.InstMem.Length :=  controller.io.IM_Length    // not used
    im.io.raddr := datapath_IF.io.Mem_Addr
    // io.InstMem.waddr := 0.U // not used
    // io.InstMem.wdata := 0.U // not used

    // === ID stage reg ==============================================================
    stage_ID.io.Flush := controller.io.Flush_BH    // To Be Modified
    stage_ID.io.Stall := (controller.io.Hcf || controller.io.Stall_MA || controller.io.Stall_DH)      // To Be Modified
    ...
    // === EXE stage reg ==============================================================
    stage_EXE.io.Flush := (controller.io.Flush_BH || controller.io.Flush_DH)   // To Be Modified
    ...
    /* controller */
    controller.io.IF_Inst := im.io.inst
    ...
    controller.io.IM_Valid := true.B    // InstMem is always valid
